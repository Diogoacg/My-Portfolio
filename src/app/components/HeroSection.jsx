...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Main content */}
      <div className="hero-container relative z-10 container mx-auto min-h-screen flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 responsive-gap items-center w-full">
          {/* Left side - Text content */}
          <motion.div
            initial={{ opacity: 0, x: -100 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 1, ease: "easeOut" }}
            className="hero-content lg:col-span-1 col-span-1 lg:text-left text-center"
          >
            ...
            >
              ...
              >
                <SparklesIcon className="icon-sm text-purple-400" />
              </motion.div>
              <span className="text-purple-300 responsive-text-sm font-medium">
            ...
            <div className="responsive-space-y">
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="hidden md:flex items-center responsive-gap mb-4 justify-center lg:justify-start">
                  <motion.div
                ...
                <TypeAnimation
                  ...
                  speed={50}
                  repeat={Infinity}
                  className="hero-subtitle min-h-[3rem]"
                />
              </motion.div>
            </div>
            ...
            >
              ...
              <p className="responsive-text-lg text-gray-300 leading-relaxed lg:pl-6 max-w-lg mx-auto lg:mx-0">
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="hero-button group relative bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl font-semibold text-white overflow-hidden"
              >
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="hero-button group flex items-center gap-2 border-2 border-gray-600 rounded-2xl font-semibold text-gray-300 hover:border-purple-500 hover:text-white transition-all duration-300 justify-center"
              >
                <DocumentArrowDownIcon className="icon-sm group-hover:text-purple-400 transition-colors" />
                Download CV
              </motion.a>
            </motion.div>
          </motion.div>
